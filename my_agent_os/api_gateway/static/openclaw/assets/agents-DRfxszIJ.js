import{i as e,n as t}from"./lit-zdTgzAJI.js";import{t as n}from"./preload-helper-BfMJCuRo.js";import{l as r}from"./format-Cbj45nru.js";import{A as i,C as a,D as o,E as s,M as c,S as l,T as u,_ as d,a as f,b as p,f as m,g as h,h as g,j as _,k as v,m as y,n as b,p as x,r as S,t as C,v as w,w as T,x as E,y as D}from"./index-BxR8Vkkd.js";import{r as O}from"./channel-config-extras-DNCeHtEf.js";import{i as k,n as A,r as j,t as M}from"./skills-shared-DJsJP4-4.js";function N(n){let{agent:r,configForm:i,agentFilesList:o,configLoading:s,configSaving:c,configDirty:u,onConfigReload:d,onConfigSave:f,onModelChange:m,onModelFallbacksChange:h,onSelectPanel:g}=n,_=p(i,r.id),v=r.model,b=(o&&o.agentId===r.id?o.workspace:null)||_.entry?.workspace||_.defaults?.workspace||r.workspace||`default`,x=_.entry?.model?l(_.entry?.model):_.defaults?.model?l(_.defaults?.model):l(v),S=l(_.defaults?.model??v),C=a(_.entry?.model),T=a(_.defaults?.model)||(S===`-`?null:w(S))||(i?null:a(v)),O=C??T??null,k=E(_.entry?.model)??E(_.defaults?.model)??(i?null:E(v))??[],A=Array.isArray(_.entry?.skills)?_.entry?.skills:null,j=A?.length??null,M=!!(n.defaultId&&r.id===n.defaultId),N=!i||s||c,P=e=>{let t=k.filter((t,n)=>n!==e);h(r.id,t)};return e`
    <section class="card">
...
//# sourceMappingURL=agents-DRfxszIJ.js.map